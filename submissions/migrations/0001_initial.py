    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='authored', to='auth.user', verbose_name='Autor')),
                ('keywords', models.ManyToManyField(blank=True, to='submissions.Keyword', verbose_name='Klíčová slova')),
                ('opponent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='opposed', to='auth.user', verbose_name='Oponent')),
                ...
                ('supervisor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='supervised', to='auth.user', verbose_name='Vedoucí')),
            ],
            options={
                'verbose_name': 'Práce',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='log_entries', to='auth.user', verbose_name='Měnil')),
            ],
            options={
                'verbose_name': 'Záznam',
